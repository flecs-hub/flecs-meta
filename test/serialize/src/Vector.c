...
void Vector_vector_bool() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorBool), &value);
...
void Vector_vector_int() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorInt), &value);
    test_str(str, "[10, -10]");
    ecs_os_free(str);
    ecs_vector_free(value);
    }
...
void Vector_vector_string() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorString), &value);
...
void Vector_vector_entity() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorEntity), &value);
...
void Vector_vector_struct() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorPoint), &value);
...
void Vector_vector_nested_struct() {
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorLine), &value);
...
void Vector_vector_vector_int() {
    ...
    *ecs_vector_add(&v2, int32_t) = -40;
    ...
    char *str = ecs_ptr_to_str(world, ecs_id(VectorVectorInt), &value);
...
void Vector_vector_vector_struct() {
    ...
    *ecs_vector_add(&v2, Point) = (Point){70, -80};
    ...
    ecs_vector_t *value = ecs_vector_from_array(ecs_vector_t*, 2, ((ecs_vector_t*[]){v1, v2}));
    char *str = ecs_ptr_to_str(world, ecs_id(VectorVectorPoint), &value);
...
void Vector_vector_vector_nested_struct() {
    ...
    *ecs_vector_add(&v2, Line) = l4;
    ...
    ecs_vector_t *value = ecs_vector_from_array(ecs_vector_t*, 2, ((ecs_vector_t*[]){v1, v2}));
    char *str = ecs_ptr_to_str(world, ecs_id(VectorVectorLine), &value);
    test_str(str, 
